...
$querySpecialization = 'select distinct specialist from doctor';
	...
	<div class="content">
		<div class="container">
					...
					<div class="features-text tg-wrap">
						<form class="form-horizontal" action="MakeAppointment.php"
							...
							<table class='tg'
								...
								<tr>
									<td>Select specialists</td>
									<td><select name="specialists" class="btn1" id="spec"
			...
			while ( $row = mysqli_fetch_array ( $getSpecialization ) ) {
				...
				echo '<option value="' . $specialists . '" >' . $specialists . '</option>';
			}
			?>
		</select></td>
								</tr>
								<tr>
									<td>Select Doctor</td>
									<td><select name="doctorname" class="btn1" id="doctor" required="required">
