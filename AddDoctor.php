			...
			<div class="content-grids">
				...
				<div class="features-info">
					<div class="features-text tg-wrap">
						<form id="form_register" class="appnitro" method="post" action="AddDoc.php">
							<table class='tg' style="width: 60%; margin-left: 20%; margin-right: 20%">
								<tr>
									<td>Email</td>
								...
								<tr>
									<td>Password</td>
									<td><input id="password" name="password" type="password" minlength="8" maxlength="12"
								...
								<tr>
									<td>Specialist</td>
									<td><input id="lname" name="specs" type="text" maxlength="255" required /></td>
								</tr>
								<tr>
									<td>Start Time</td>
									<td><input id="lname" name="start" type="time" step="2" required /></td>
								</tr>
								<tr>
									<td>End Time</td>
									<td><input id="lname" name="end" type="time" step="2" required /></td>
								</tr>
								<tr>
									<td>Gender</td>
								...
								<tr>
									<td>Birth Date</td>
									<td><input type="Date" id="date" name="date" max="2019-04-01
